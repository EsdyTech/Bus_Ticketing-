...
while($row = mysqli_fetch_array($result))
	{
		...
		$query = mysqli_query("SELECT sum(seat_reserve) FROM reserve where date = '$date'");
...
if (e==null || e=="")
  ...
  var f=document.forms["form"]["conPassword"].value;
if (f==null || f=="")
  {
...
<input type="password" name="conPassword"  id="name"/><br>
<label>Address
